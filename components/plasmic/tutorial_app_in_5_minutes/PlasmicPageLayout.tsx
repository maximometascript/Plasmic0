...
// Plasmic Project: 5mW9qPA5gfrkJUBkcB8SZV
// Component: X0_fwZFP_Gil
...
import projectcss from "./plasmic.module.css"; // plasmic-import: 5mW9qPA5gfrkJUBkcB8SZV/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: X0_fwZFP_Gil/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 58989gJ5rygP/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: vX3EOjaDSaaV/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__udE5W)}
          role={"img"}
        />
      }
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__usLy)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__fowxq)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__wDew)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___1GX1S)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
